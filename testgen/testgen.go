...
func GenerateTestApplicationXML(body string, server string, apiCall string, query string, sharedSecret string, testcomment string) {
	...
	str := fmt.Sprintf(`
		...
		*/
		...
		`,
		apiCall, query, body, sharedSecret, testcomment,
...
func GenerateTestURLEncoded(body url.Values, server string, apiCall string, query string, sharedSecret string, testcomment string) {
	u, err := url.Parse(server)
	if err != nil {
		fmt.Println(err)
		return
	...
	str := fmt.Sprintf(`
		...
		*/
		...
		`,
		apiCall, query, body.Encode(), sharedSecret, testcomment,
		u.Hostname(), u.Port(), u.Path,
		inFromValues(queryValues),
